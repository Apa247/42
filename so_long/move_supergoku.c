...
void	move_supergoku_y(t_map *map)
{
	if (map->n_frames == 0)
	{
		...
		if (map->pl_dir == 0)
			...
			put_imagen_xpm(map, "./sprites/supergoku_move_y_left.xpm", map->py, map->px);
	}
	if (map->n_frames == 400)
	{
		put_imagen_xpm(map, "./sprites/suelo.xpm", map->py, map->px);
		if (map->pl_dir == 0)
			...
			put_imagen_xpm(map, "./sprites/supergoku_move_y2_left.xpm", map->py, map->px);
	}
...
void	put_supergoku_map_x(t_map *map)
{
	...
	{
		map->px--;
		put_imagen_xpm(map, "./sprites/supergoku_move_x2_left.xpm", map->py, map->px);
	}
	...
	{
		map->px++;
		put_imagen_xpm(map, "./sprites/supergoku_move_x2.xpm", map->py, map->px);
	}
